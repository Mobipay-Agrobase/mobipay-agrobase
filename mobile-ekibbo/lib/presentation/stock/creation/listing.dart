...
import 'package:agrobase_ekibbo/presentation/stock/creation/widgets/creation_item.dart';
import 'package:agrobase_ekibbo/routes/routes_manager.dart';

class ScreenStockCreationListing extends StatefulWidget {
  const ScreenStockCreationListing({super.key});

  @override
  State<ScreenStockCreationListing> createState() =>
      _ScreenCheckFishingListingState();
}

class _ScreenCheckFishingListingState
    extends State<ScreenStockCreationListing> {
  @override
  ...
  _buildFuture() {
    return FutureBuilder(
      future: DListingData.instance.fetchStockCreation(), // async work
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            if (snapshot.hasError) {
              ...
              final datas = snapshot.data as List<StockCreationResponse>;
