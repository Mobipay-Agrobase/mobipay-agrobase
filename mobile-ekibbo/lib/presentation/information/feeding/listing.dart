...
import 'package:agrobase_ekibbo/presentation/information/feeding/widgets/feeding_item.dart';
import 'package:agrobase_ekibbo/routes/routes_manager.dart';

class ScreenFeedingListing extends StatefulWidget {
  const ScreenFeedingListing({super.key});

  @override
  State<ScreenFeedingListing> createState() =>
      _ScreenCheckFishingListingState();
}

class _ScreenCheckFishingListingState extends State<ScreenFeedingListing> {
  @override
  ...
  _buildFuture() {
    return FutureBuilder(
      future: DListingData.instance.fetchFeeding(), // async work
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            if (snapshot.hasError) {
              ...
              final datas = snapshot.data as List<FeedingInfoResponse>;
