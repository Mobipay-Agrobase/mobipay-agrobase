...
class ScreenStockTransferListing extends StatefulWidget {
  const ScreenStockTransferListing({super.key});

  @override
  State<ScreenStockTransferListing> createState() =>
      _ScreenCheckFishingListingState();
}

class _ScreenCheckFishingListingState
    extends State<ScreenStockTransferListing> {
  @override
  ...
  _buildFuture() {
    return FutureBuilder(
      future: DListingData.instance.fetchStockTransfer(), // async work
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            if (snapshot.hasError) {
              ...
              final datas = snapshot.data as List<StockTransferResponse>;
