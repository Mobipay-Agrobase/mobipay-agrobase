...
export async function middleware(request: NextRequest) {
  ...
  if (moduleMatch) {
    ...
    const MODULE_ALIASES: Record<string, string> = {
      ...
      'ekibbo-farmer-detail': 'farmers',
      'ekibbo-geo': 'farmers',
      'ekibbo-farmer': 'farmers',
      'ekibbo-farmers': 'farmers',
      'ekibbo-home': 'dashboard',
      'ekibbo-home-farmer': 'dashboard',
      'ekibbo-profile': 'profile',
      'ekibbo-crop-dropdowns': 'farmers',
      'ekibbo-register-dropdowns': 'farmers',
      'escrow': 'payments',
