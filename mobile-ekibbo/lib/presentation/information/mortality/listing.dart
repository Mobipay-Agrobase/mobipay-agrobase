...
import 'package:agrobase_ekibbo/presentation/information/mortality/widgets/mortality_item.dart';
import 'package:agrobase_ekibbo/routes/routes_manager.dart';

class ScreenMortalityListing extends StatefulWidget {
  const ScreenMortalityListing({super.key});

  @override
  State<ScreenMortalityListing> createState() =>
      _ScreenCheckFishingListingState();
}

class _ScreenCheckFishingListingState extends State<ScreenMortalityListing> {
  @override
  ...
  _buildFuture() {
    return FutureBuilder(
      future: DListingData.instance.fetchMortality(), // async work
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            if (snapshot.hasError) {
              ...
              final datas = snapshot.data as List<MortalitiesInfoResponse>;
