...
class TransferItem extends StatelessWidget {
  final StockTransferResponse item;
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  _buildItem('Date',
                      DateHelper.convertTimestampToDate(item.transferDate).toString()),
                  _buildItem('Farmer', item.farmerName),
                  _buildItem('Pond', item.pondName),
                  _buildItem('Avg Weight', item.availableWeight.toString()),
                  _buildItem('Species Count', item.speciesCount.toString()),
                  _buildItem('Destination Pond', item.destinationPond),
                  _buildItem('Number Of Fishes Transfered', item.numberOfFishesTransfered.toString()),
