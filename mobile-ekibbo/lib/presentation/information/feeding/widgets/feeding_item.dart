...
class FeedingItem extends StatelessWidget {
  final FeedingInfoResponse item;
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  _buildItem('Date',
                      DateHelper.convertTimestampToDate(item.feedingDate).toString()),
                  _buildItem('Farmer', item.farmerName),
                  _buildItem('Pond', item.pondName),
                  _buildItem('Type', item.typeOfFeed),
                  _buildItem('Feeder', item.feederName),
                  _buildItem('Feed give', item.feedGiven.toString()),
                  _buildItem('Feed min', item.approvedFeedMin.toString()),
                  _buildItem('Feed max', item.approvedFeedMax.toString()),
