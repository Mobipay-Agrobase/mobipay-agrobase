...
DropdownFarmLandModel _$DropdownFarmLandModelFromJson(
    ...
    DropdownFarmLandModel()
      ...
      ..dataLandWwnerShip = (json['data_land_owner_ship'] as List<dynamic>?)
          ?.map((e) => DropdownDataModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..dataWaterSource = (json['data_water_source'] as List<dynamic>?)
          ?.map((e) => DropdownDataModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..dataPowerSource = (json['data_power_source'] as List<dynamic>?)
          ?.map((e) => DropdownDataModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..dataSoilFertility = (json['data_soil_fertility'] as List<dynamic>?)
          ?.map((e) => DropdownDataModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..dataIrrigationType = (json['data_irrigation_type'] as List<dynamic>?)
          ?.map((e) => DropdownDataModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..dataIrrigationSource = (json['data_irrigation_source'] as List<dynamic>?)
          ?.map((e) => DropdownDataModel.fromJson(e as Map<String, dynamic>))
          .toList()
