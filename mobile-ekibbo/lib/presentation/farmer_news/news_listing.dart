...
class ScreenNewsListing extends StatelessWidget {
  final List<String> tabs = ["New", "Advisory"];
  final List<Widget> tabViews = [const NewsTab(), const NewsTab()];

  ScreenNewsListing({super.key});
