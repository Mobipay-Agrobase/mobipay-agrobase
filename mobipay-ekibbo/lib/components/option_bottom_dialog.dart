...
import 'package:mobipay_ekibbo/components/radio_button.dart';
...
class _OptionBottomDialogState extends State<OptionBottomDialog> {
  ...
  void initState() {
    super.initState();
    if (widget.itemSelected == null) return;
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final index = widget.datas.indexWhere((e) => e == widget.itemSelected);
