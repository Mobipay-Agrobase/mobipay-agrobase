...
export function TopBar({ simulationStatus, onSimulationChange }: TopBarProps) {
  ...
  return (
    <header className="h-14 sm:h-16 border-b border-border bg-card/80 backdrop-blur-md flex items-center px-3 sm:px-4 lg:px-6 gap-2 sm:gap-4 shrink-0 sticky top-0 z-30">
      <Button
        variant="ghost"
        size="icon"
      ...
      <div className="hidden md:flex items-center relative max-w-xs w-full">
        ...
        <Input
          placeholder="Search farmers, modules..."
