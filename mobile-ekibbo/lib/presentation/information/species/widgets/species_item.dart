...
class SpeciesItem extends StatelessWidget {
  final SpeciesInfoResponse item;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  _buildItem(
                      'Date',
                      DateHelper.convertTimestampToDate(item.dateOfAdding)
                          .toString()),
                  _buildItem('Species', item.speciesName),
                  _buildItem('Variety', item.speciesVarietyName),
                  _buildItem('Count', item.speciesCount.toString()),
                  _buildItem(
                    'Expected harvest qty',
                    '${item.expectedHarvestQty} kg',
                  ),
