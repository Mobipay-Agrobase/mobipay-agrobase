...
class CheckFishingItem extends StatelessWidget {
  final CheckFishingResponse item;
  final Function onUpdate;

  const CheckFishingItem({
    Key? key,
    required this.item,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _buildItem('Type', item.typesOfCheckFishing),
                  _buildItem('Weight', item.weight.toString()),
                  _buildItem('Number', item.number.toString()),
